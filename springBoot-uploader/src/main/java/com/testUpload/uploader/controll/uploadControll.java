package com.testUpload.uploader.controll;
...
import com.testUpload.uploader.repository.imageReposit;
...
public class uploadControll {
    ...
    public ResponseEntity<?> uplaodImage(@RequestParam("imageFile") MultipartFile file) throws IOException {
        ...
        ImageReposit.save(img);
        return ResponseEntity.ok(HttpStatus.OK);
    }

    @GetMapping(path = {"/get/{imageName}"})
    public model getImage(@PathVariable("imageName") String imageName) throws IOException {

        final Optional<model> retrievedImage = ImageReposit.findByName(imageName);
